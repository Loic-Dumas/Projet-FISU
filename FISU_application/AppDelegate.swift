...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var coreDataManager: FisuCoreDataManager? = nil
    var event: Event? = nil

    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        // Override point for customization after application launch.
        
        self.coreDataManager = FisuCoreDataManager()
        self.event = self.coreDataManager?.loadData()
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("tmp15.sqlite")
